				...
				nodes.forEach(function(values) {
							...
							if(entries.moteid == values) {
								for (key in entries) {
									if(key == readingType) {
										...
										var myObj = {
											modeid: entries.moteid, 
											type: key, 
											reading: tmp, 
											dateOfReading: entries.readingDate
										};
					...
					arrEntriesTypes.forEach(function(readingType) {
						...
						arrSensor.forEach(function(sensorReading) {
							if(readingType == sensorReading.type) {
								var myObj = {
									...
									dateOfReading: sensorReading.dateOfReading
								};
						...
						var allReadingsObj = {
							...
							Min: minValue, 
							dateOfMin: minDate, 
							lowerRangeOfReadingDate: rangeDateMin, 
							upperRangeOfReadingDate: rangeDateMax
						};
						var readingObj = {
							sensorType: readingType, 
							values: allReadingsObj
						};
